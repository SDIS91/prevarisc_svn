<?php
    ...
    class StatistiquesController extends Zend_Controller_Action
    {
        ...
        private $liste = array (
            ...
            "liste-des-erp-sous-avis-defavorable" => "Extraction 2 : Liste des ERP et IGH sous avis défavorable",
        ...
        public function listeDesErpSousAvisDefavorableAction()
        {
            ...
            {
                $date = new Zend_Date($this->_getParam("date"), Zend_Date::DATES);
                $this->view->resume = "Liste ERP et IGH en exploitation sous avis défavorable à la date du " . $date->get( Zend_Date::WEEKDAY." ".Zend_Date::DAY_SHORT." ".Zend_Date::MONTH_NAME_SHORT." ".Zend_Date::YEAR );
            }
                ...
                array (
                    "tri" => array(
                        ...
                        "data" => array (
                            ...
                            "Local à sommeil" => "LOCALSOMMEIL_ETABLISSEMENTINFORMATIONS",
                            "Type" => "LIBELLE_TYPE",
